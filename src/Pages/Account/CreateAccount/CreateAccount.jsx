...
const CreateAccount = () => {
  const { loading, setLoading, createNewUserWithEmail, logOut } =
  ...
  return (
    <div className="max-w-md mx-auto shadow-2xl min-h-[91vh] flex flex-col justify-center px-4">
      <form onSubmit={handleCreateAccount} className="space-y-4">
        ...
        <div>
          <button
            ...
            disabled={loading}
          >
            {loading ? <SimpleLoader /> : "Create Request"}
          </button>
        </div>
      </form>
    </div>
